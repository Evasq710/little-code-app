...
class Dato:
    def __init__(self, id_node, label, inicio = False, no_terminal = False, hoja_lexema = False, syntax_error = False, id_nodo_padre = None):
...
class Nodo:
    ...
    def crear_nodos_graphviz(self):
        if self.dato.inicio:
            ...
            self.str_nodos_graphviz += f'node{self.dato.id_node}[label="{self.dato.label}", fillcolor="sienna2"];\n'
